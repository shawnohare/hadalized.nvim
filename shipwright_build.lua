...
run(
    dark_theme,
    lushwright.to_lua,
    {overwrite, "lua/hadalized_dark.lua"}
)

run(
    light_theme,
    lushwright.to_lua,
    {overwrite, "lua/hadalized_light.lua"}
)
...
run(
    ...
    {append, {"set background=dark", "let g:colors_name=\"hadalized\""}},
    ...
    {overwrite, "colors/hadalized_dark.vim"}
)

run(
    light_theme,
    lushwright.to_vimscript,
    {append, {"set background=light", "let g:colors_name=\"hadalized\""}},
    {overwrite, "colors/hadalized_light.vim"}
)
